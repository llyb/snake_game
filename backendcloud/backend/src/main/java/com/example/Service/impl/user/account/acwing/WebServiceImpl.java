...
import com.example.Service.user.account.acwing.WebService;
...
public class WebServiceImpl implements WebService {
    ...
    private final static String redirectUri = "https://app6053.acapp.acwing.com.cn/user/account/acwing/web/receive_code/"; // 回调函数 前端进行实现
